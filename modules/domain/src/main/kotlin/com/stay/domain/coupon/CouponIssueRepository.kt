 ...
 * myCoupons 조회 유스케이스의 findByUserId, 예약 쿠폰 적용 유스케이스의 findById 를 노출한다.
 *
 * Refs:
 *  - docs/round-4/02-tdd-plan.md B.4 CouponService.issue (CSVC-01~06), myCoupons (CSVC-07~11), ReservationService 쿠폰 적용 (RSVC2-01~10)
