...
AI 는 너무 많은 컨텍스트 (정보) 를 세션 내에서 관리하게 되면 혼란이 찾아올 수 있어요.
좀 더 안정적으로 이를 제어하기 위해서는 필요한 기능만 적재적소에 사용할 수 있게 하는 것이 중요합니다.

AI 에게 전문가 매뉴얼들을 제공하면, 더 효율적으로 필요한 지침을 찾아 업무를 수행할 수 있어요.

</aside>

- 특정 작업을 더 전문적이고 효율적으로 수행하도록 돕는 맞춤형 지침, 스크립트, 리소스 모음
- **주요 특징**
    - **작업 자동화**: 클릭만으로 네이버 마케팅 최적화 글쓰기, 규격에 맞는 PPT 제작 등 반복 작업을 자동화
    - **전문성 확장**: 사용자의 전문 지식(코드 기준, 데이터 분석 규칙 등)을 패키징하여 클로드의 기능을 확장
    - **효율적인 로딩**: 세션 시작 시에는 이름과 설명만 로드하고, 필요할 때만 상세 내용과 스크립트를 불러와 토큰을 절약
    - **조합 및 활용**: 여러 스킬을 함께 사용하거나 클로드가 자동으로 필요한 스킬을 조합하여 활용
    - **커스텀 제작:** 스킬 크리에이터나 YAML 파일 업로드를 통해 누구나 자신만의 스킬 제작
        - antrophic 이 제공하는 [**skill-creator SKILL**](https://github.com/anthropics/skills/tree/main/skills/skill-creator) 을 활용해 쉽게 제작할 수 있음

### 참고

[Agent Skills - Claude Code Docs](https://code.claude.com/docs/ko/skills)
